  ...
  describe("constructor", () => {
    describe("arguments", () => {
      ...
      describe("options", () => {
        ...
        describe(".magic", () => {
          it("defaults to true. (i.e. 'nomagic')", () => {
            const regex = new VimRegExp(".");
            assertMatch("x", regex);
          });
          it("turns on 'magic' if true.", () => {
            const regex = new VimRegExp(".", { magic: true });
            assertMatch("x", regex);
          });
          it("turns off 'magic' if false. (i.e. 'nomagic')", () => {
            const regex = new VimRegExp(".", { magic: false });
            assertMatch(".", regex, "'.' matches a literal '.'.");
            assertNotMatch("x", regex);
          });
        });
        describe(".ignorecase", () => {
          it("defaults to false. (i.e. 'noignorecase')", () => {
            const regex = new VimRegExp("foo");
            assertMatch("foo", regex);
            assertNotMatch("Foo", regex);
          });
          it("turns on 'ignorecase' if true.", () => {
            const regex = new VimRegExp("foo", { ignorecase: true });
            assertMatch("foo", regex);
            assertMatch("Foo", regex);
          });
          it("turns off 'ignorecase' if false. (i.e. 'noignorecase')", () => {
            const regex = new VimRegExp("foo", { ignorecase: false });
            assertMatch("foo", regex);
            assertNotMatch("Foo", regex);
          });
        });
        describe(".smartcase", () => {
          it("defaults to false. (i.e. 'nosmartcase')", () => {
            const regex = new VimRegExp("Foo", { ignorecase: true });
            assertMatch("Foo", regex);
            assertMatch("foo", regex);
          });
          it("turns on 'smartcase' if true.", () => {
            const regex = new VimRegExp("Foo", { ignorecase: true, smartcase: true });
            assertMatch("Foo", regex);
            assertNotMatch("foo", regex);
          });
          it("turns off 'smartcase' if false. (i.e. 'nosmartcase')", () => {
            const regex = new VimRegExp("Foo", { ignorecase: true, smartcase: false });
            assertMatch("Foo", regex);
            assertMatch("foo", regex);
          });
        });
        describe(".stringMatch", () => {
          ...
          it("turns on 'stringMatch' if true.", () => {
            const regex = new VimRegExp("^foo", { stringMatch: true });
            assertMatch("foo\nbar", regex);
            assertNotMatch("bar\nfoo", regex);
          });
          it("turns off 'stringMatch' if false.", () => {
            const regex = new VimRegExp("^foo", { stringMatch: false });
            assertMatch("foo\nbar", regex);
            assertMatch("bar\nfoo", regex);
          });
        });
    ...
    it("throws an error wrapping an internal error.", () => {
    ...
    it("throws an unexpected error without wrapping it.", () => {
      const pattern = new String("foo");
      const expected = new Error("Foobar error");
      stub(pattern, Symbol.iterator, function () {
        throw expected;
      });
      const error = assertThrows(
        () => new VimRegExp(pattern as string),
        Error,
      );
...
describe("Regular expression patterns in VimRegExp", () => {
  describe("Quantifiers", () => {
    ...
    describe("*", () => {
      ...
      describe("when 'very magic'", () => {
        it("is quantifier if not prefixed.", () => {
          const regex = new VimRegExp("\\vx*");
          assertMatchResult("xxx", regex, ["xxx"]);
        });
        it("matches literal '*' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\vx\\*");
          assertMatchResult("x*", regex, ["x*"]);
        });
      });
      describe("when 'magic'", () => {
        it("is quantifier if not prefixed.", () => {
      ...
      describe("when 'nomagic'", () => {
        it("matches literal '*' if not prefixed.", () => {
          const regex = new VimRegExp("\\Mx*");
          assertMatchResult("x*", regex, ["x*"]);
        });
        it("is quantifier if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\Mx\\*");
          assertMatchResult("xxx", regex, ["xxx"]);
        });
      });
      describe("when 'very nomagic'", () => {
        it("matches literal '*' if not prefixed.", () => {
          const regex = new VimRegExp("\\Vx*");
          assertMatchResult("x*", regex, ["x*"]);
        });
    ...
    describe("\\{", () => {
      ...
      describe("when 'very magic'", () => {
        ...
        it("matches literal '{' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\vx\\{2,3}");
          assertMatchResult("x{2,3}", regex, ["x{2,3}"]);
        });
        it("throws error when '}' is missing.", () => {
          assertThrows(
            () => new VimRegExp("\\vx{2,3"),
            VimRegExpSyntaxError,
            ":3: Incomplete quantifier: '\\{...}'",
          );
        });
        it("throws error when without preceding atom.", () => {
          assertThrows(
            () => new VimRegExp("\\v{2,3}"),
            VimRegExpSyntaxError,
            "Nothing to repeat",
    ...
    describe("\\@123<=", () => {
      ...
      describe("when 'very magic'", () => {
        ...
        it("matches literal '@123' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\vx\\@123<=");
          assertMatchResult("x@123<=", regex, ["x@123"]);
        });
      });
      describe("when 'magic'", () => {
        it("matches literal '@123' if not prefixed.", () => {
    ...
    describe("\\@<!", () => {
      ...
      describe("when 'very magic'", () => {
        ...
        it("matches literal '@' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\vx\\@<!", { iskeyword: "!" });
          assertMatchResult("x@!", regex, ["x@!"]);
        });
      });
      describe("when 'magic'", () => {
    ...
    describe("\\@123<!", () => {
      ...
      describe("when 'very magic'", () => {
        ...
        it("matches literal '@123' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\vx\\@123<!", { iskeyword: "!" });
          assertMatchResult("x@123!", regex, ["x@123!"]);
        });
      });
      describe("when 'magic'", () => {
    ...
    describe("\\@>", () => {
      ...
      describe("when 'very magic'", () => {
        it("throws UnsupportedSyntaxError if not prefixed.", () => {
          assertThrows(
            () => new VimRegExp("\\vx@>"),
            UnsupportedSyntaxError,
            ": \\@>",
      ...
      describe("when 'magic'", () => {
        ...
        it("throws UnsupportedSyntaxError if prefixed with '\\'.", () => {
          assertThrows(
            () => new VimRegExp("\\mx\\@>"),
            UnsupportedSyntaxError,
            ": \\@>",
  ...
  describe("Ordinary atoms", () => {
    describe("^", () => {
      ...
      describe("when 'very magic'", () => {
        it("matches start-of-line if not prefixed.", () => {
          const regex = new VimRegExp("\\v^foo");
          assertMatchResult("foo", regex, ["foo"]);
        });
        it("matches literal '^' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\v\\^foo");
      ...
      describe("when 'magic'", () => {
        it("matches start-of-line if not prefixed.", () => {
          const regex = new VimRegExp("\\m^foo");
          assertMatchResult("foo", regex, ["foo"]);
        });
        it("matches literal '^' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\m\\^foo");
      ...
      describe("when 'very nomagic'", () => {
        ...
        it("matches start-of-line if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\V\\^foo");
          assertMatchResult("foo", regex, ["foo"]);
        });
      });
    ...
    describe("\\_^", () => {
      ...
      describe("when 'very magic'", () => {
        it("matches literal '_' if not prefixed.", () => {
          const regex = new VimRegExp("\\v\\n_^foo");
          assertMatchResult("\n_^foo", regex, ["\n_^foo"]);
        });
        it("matches start-of-line if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\v\\n\\_^foo");
    ...
    describe("$", () => {
      ...
      describe("when 'very magic'", () => {
        it("matches end-of-line if not prefixed.", () => {
          const regex = new VimRegExp("\\vfoo$");
          assertMatchResult("foo", regex, ["foo"]);
        });
        it("matches literal '$' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\vfoo\\$");
      ...
      describe("when 'magic'", () => {
        it("matches end-of-line if not prefixed.", () => {
          const regex = new VimRegExp("\\mfoo$");
          assertMatchResult("foo", regex, ["foo"]);
        });
        it("matches literal '$' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\mfoo\\$");
      ...
      describe("when 'very nomagic'", () => {
        ...
        it("matches end-of-line if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\Vfoo\\$");
          assertMatchResult("foo", regex, ["foo"]);
        });
      });
    ...
    describe("\\_$", () => {
      ...
      describe("when 'very magic'", () => {
        it("matches literal '_' if not prefixed.", () => {
          const regex = new VimRegExp("\\vfoo_$\n");
          assertMatchResult("foo_$\n", regex, ["foo_$\n"]);
        });
        it("matches end-of-line if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\vfoo\\_$\n");
          assertMatchResult("foo\nbar", regex, ["foo\n"]);
        });
      });
      describe("when 'magic'", () => {
        it("matches literal '_' if not prefixed.", () => {
          const regex = new VimRegExp("\\mfoo_$\n");
          assertMatchResult("foo_$\n", regex, ["foo_$\n"]);
        });
        it("matches end-of-line if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\mfoo\\_$\n");
          assertMatchResult("foo\nbar", regex, ["foo\n"]);
        });
      });
      describe("when 'nomagic'", () => {
    ...
    describe("\\_.", () => {
      ...
      describe("when 'very magic'", () => {
        it("matches literal '_' if not prefixed.", () => {
          const regex = new VimRegExp("\\v_.");
          assertMatchResult("_x", regex, ["_x"]);
        });
        it("matches any single character or '\\n' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\v\\_.");
          assertMatchResult("\n", regex, ["\n"]);
        });
      });
      describe("when 'magic'", () => {
        it("matches literal '_' if not prefixed.", () => {
          const regex = new VimRegExp("\\m_.");
          assertMatchResult("_x", regex, ["_x"]);
        });
        it("matches any single character or '\\n' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\m\\_.");
          assertMatchResult("\n", regex, ["\n"]);
        });
      });
      describe("when 'nomagic'", () => {
    ...
    describe("\\<", () => {
      ...
      describe("when 'very magic'", () => {
        it("matches beginning of word if not prefixed.", () => {
          const regex = new VimRegExp("\\v<foo");
          assertMatchResult("foo", regex, ["foo"]);
        });
        it("matches literal '<' if prefixed with '\\'.", () => {
      ...
      describe("when 'magic'", () => {
        ...
        it("matches beginning of word if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\m\\<foo");
          assertMatchResult("foo", regex, ["foo"]);
        });
      });
    ...
    describe("\\>", () => {
      ...
      describe("when 'very magic'", () => {
        it("matches end of word if not prefixed.", () => {
          const regex = new VimRegExp("\\vfoo>");
          assertMatchResult("foo", regex, ["foo"]);
        });
        it("matches literal '>' if prefixed with '\\'.", () => {
      ...
      describe("when 'magic'", () => {
        ...
        it("matches end of word if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\mfoo\\>");
          assertMatchResult("foo", regex, ["foo"]);
        });
      });
    ...
    describe("\\%^", () => {
      ...
      describe("when 'very magic'", () => {
        ...
        it("does not match anything if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\v\\%^foo");
          assertNotMatch("foo", regex);
        });
      });
  ...
  describe("Grouping", () => {
    describe("\\(\\)", () => {
      ...
      it("throws error if an unmatched '\\)' is appears.", () => {
        assertThrows(
          () => new VimRegExp("\\(foo\\)bar\\)"),
          VimRegExpSyntaxError,
          ":10: Unmatched '\\)'",
        );
      });
      describe("when 'very magic'", () => {
        it("encloses a pattern if not prefixed.", () => {
          const regex = new VimRegExp("\\v(foo)");
          assertMatchResult("foo", regex, ["foo", "foo"]);
        });
        it("matches literal '()' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\v\\(foo\\)");
          assertMatchResult("(foo)", regex, ["(foo)"]);
      ...
      describe("when 'magic'", () => {
        ...
        it("encloses a pattern if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\m\\(foo\\)");
          assertMatchResult("foo", regex, ["foo", "foo"]);
        });
      });
    ...
    describe("\\|", () => {
      ...
      describe("when 'very magic'", () => {
        it("splits the pattern if not prefixed.", () => {
      ...
      describe("when 'magic'", () => {
        ...
        it("splits the pattern if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\mfoo\\|bar");
          assertMatch("foo", regex);
          assertMatch("bar", regex);
        });
    ...
    describe("\\&", () => {
      ...
      describe("when 'very magic'", () => {
        it("splits the branch if not prefixed.", () => {
        ...
        it("matches literal '&' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\vf\\&.oo");
          assertMatchResult("f&xoo", regex, ["f&xoo"]);
        });
      });
      describe("when 'magic'", () => {
        it("matches literal '&' if not prefixed.", () => {
        ...
        it("splits the branch if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\mf\\&.oo");
          assertMatch("foo", regex);
          assertNotMatch("fox", regex);
        });
  ...
  describe("Collection", () => {
    describe("[]", () => {
      ...
      it("matchs literal '[]' if it is empty.", () => {
        const regex = new VimRegExp("x[]");
        assertMatchResult("x[]", regex, ["x[]"]);
      });
      describe("when 'very magic'", () => {
        it("matches any single character in the collection sequence if not prefixed.", () => {
      ...
      describe("when 'nomagic'", () => {
        ...
        it("matches any single character in the collection sequence if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\Mx\\[ab]");
          assertMatch("xa", regex);
          assertMatch("xb", regex);
        });
    ...
    describe("\\_[]", () => {
      ...
      describe("when 'very magic'", () => {
        it("matches literal '_' if not prefixed.", () => {
          ...
          assertMatch("x_a", regex);
          assertMatch("x_b", regex);
        });
        it("matches '\\n' and any single character in the collection sequence if prefixed with '\\'.", () => {
      ...
      describe("when 'magic'", () => {
        it("matches literal '_' if not prefixed.", () => {
          const regex = new VimRegExp("\\mx_[ab]");
          assertMatch("x_a", regex);
          assertMatch("x_b", regex);
        });
        it("matches '\\n' and any single character in the collection sequence if prefixed with '\\'.", () => {
      ...
      describe("when 'nomagic'", () => {
        it("matches literal '_' if not prefixed.", () => {
          const regex = new VimRegExp("\\Mx_[ab]");
          assertMatchResult("x_[ab]", regex, ["x_[ab]"]);
        });
        it("matches '\\n' and any single character in the collection sequence if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\Mx\\_[ab]");
          assertMatch("xa", regex);
  ...
  describe("Character code", () => {
    describe("\\%d123", () => {
      ...
      describe("when 'very magic'", () => {
        it("represents character if not prefixed.", () => {
          const regex = new VimRegExp("\\v%d123");
          assertMatchResult("\x7b", regex, ["\x7b"]);
        });
        it("matches literal '%' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\v\\%d123");
          assertMatchResult("%d123", regex, ["%d123"]);
        });
      });
      describe("when 'magic'", () => {
        it("matches literal '%' if not prefixed.", () => {
          const regex = new VimRegExp("\\m%d123");
          assertMatchResult("%d123", regex, ["%d123"]);
        });
        it("represents character if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\m\\%d123");
          assertMatchResult("\x7b", regex, ["\x7b"]);
        });
      });
    ...
    describe("\\%o40", () => {
      ...
      describe("when 'very magic'", () => {
        it("represents character if not prefixed.", () => {
          const regex = new VimRegExp("\\v%o40");
          assertMatchResult("\x20", regex, ["\x20"]);
        });
        it("matches literal '%' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\v\\%o40");
          assertMatchResult("%o40", regex, ["%o40"]);
        });
      });
      describe("when 'magic'", () => {
        it("matches literal '%' if not prefixed.", () => {
          const regex = new VimRegExp("\\m%o40");
          assertMatchResult("%o40", regex, ["%o40"]);
        });
        it("represents character if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\m\\%o40");
    ...
    describe("\\%x20", () => {
      ...
      describe("when 'very magic'", () => {
        it("represents character if not prefixed.", () => {
          const regex = new VimRegExp("\\v%x20");
          assertMatchResult("\x20", regex, ["\x20"]);
        });
        it("matches literal '%' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\v\\%x20");
      ...
      describe("when 'magic'", () => {
        it("matches literal '%' if not prefixed.", () => {
          const regex = new VimRegExp("\\m%x20");
          assertMatchResult("%x20", regex, ["%x20"]);
        });
        it("represents character if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\m\\%x20");
    ...
    describe("\\%u20AC", () => {
      ...
      describe("when 'very magic'", () => {
        it("represents character if not prefixed.", () => {
          const regex = new VimRegExp("\\v%u20AC");
          assertMatchResult("\u20ac", regex, ["\u20ac"]);
        });
        it("matches literal '%' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\v\\%u20AC");
          assertMatchResult("%u20AC", regex, ["%u20AC"]);
        });
      });
      describe("when 'magic'", () => {
        it("matches literal '%' if not prefixed.", () => {
          const regex = new VimRegExp("\\m%u20AC");
          assertMatchResult("%u20AC", regex, ["%u20AC"]);
        });
        it("represents character if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\m\\%u20AC");
    ...
    describe("\\%U1234abcd", () => {
      ...
      describe("when 'very magic'", () => {
        it("represents character if not prefixed.", () => {
          const regex = new VimRegExp("\\v%U1234a");
          assertMatchResult("\u{1234a}", regex, ["\u{1234a}"]);
        });
        it("matches literal '%' if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\v\\%U1234a");
          assertMatchResult("%U1234a", regex, ["%U1234a"]);
        });
      });
      describe("when 'magic'", () => {
        it("matches literal '%' if not prefixed.", () => {
          const regex = new VimRegExp("\\m%U1234a");
          assertMatchResult("%U1234a", regex, ["%U1234a"]);
        });
        it("represents character if prefixed with '\\'.", () => {
          const regex = new VimRegExp("\\m\\%U1234a");
  ...
  describe("Unknown characters", () => {
    describe("\\x (x is no special meaning character)", () => {
      const unknownCharacters = "gjqyBEGJNQRTY!\"#',/:;\\`";
      for (const c of unknownCharacters) {
        describe(`\\${c}`, () => {
          it("matches specified character.", () => {
            const regex = new VimRegExp(`^\\${c}$`);
            assertMatch(`${c}`, regex);
            assertNotMatch("Z", regex);
          });
        });
    ...
    describe("\\x (x is character code 0x80 or higher)", () => {
      it("is never matched.", () => {
        const regex = new VimRegExp("\\\x80");
        assertNotMatch("\x80", regex);
        assertNotMatch("Z", regex);
      });
    });
    describe("\\zx (x is not reserved character)", () => {
      it("throws error if '\\z' is followed by unknown character.", () => {
        assertThrows(
          () => new VimRegExp("\\zg"),
          VimRegExpSyntaxError,
          "Invalid keyword: \\zg",
      ...
      it("throws error if '\\z' is followed by no characters.", () => {
        assertThrows(
          () => new VimRegExp("\\z"),
          VimRegExpSyntaxError,
          "Invalid keyword: \\z",
    ...
    describe("\\_x (x is not reserved character)", () => {
      it("throws error if '\\_' is followed by unknown character.", () => {
        assertThrows(
          () => new VimRegExp("\\_g"),
          VimRegExpSyntaxError,
          "Invalid char class: \\_g",
        );
      });
      it("throws error if '\\_' is followed by no characters.", () => {
        assertThrows(
          () => new VimRegExp("\\_"),
          VimRegExpSyntaxError,
          "Invalid char class: \\_",
        );
      });
    });
    describe("\\%x (x is not reserved character)", () => {
      it("throws error if '\\%' is followed by unknown character.", () => {
        assertThrows(
          () => new VimRegExp("\\%g"),
          VimRegExpSyntaxError,
          "Invalid keyword: \\%g",
      ...
      it("throws error if '\\%' is followed by no characters.", () => {
        assertThrows(
          () => new VimRegExp("\\%"),
          VimRegExpSyntaxError,
          "Invalid keyword: \\%",
